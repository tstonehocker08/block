...
# Unbound Size
sparkus=$(ls -lah $spk/unbound.conf.gz | awk '{print $5}')
basicus=$(ls -lah $bsc/unbound.conf.gz | awk '{print $5}')
bluus=$(ls -lah $hblu/unbound.conf.gz | awk '{print $5}')
blugous=$(ls -lah $bGo/unbound.conf.gz | awk '{print $5}')
pornus=$(ls -lah $prn/unbound.conf.gz | awk '{print $5}')
ultimateus=$(ls -lah $ulm/unbound.conf.gz | awk '{print $5}')
unifiedus=$(ls -lah $unf/unbound.conf.gz | awk '{print $5}')
# RPZ Size
