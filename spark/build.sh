...
date=$(date +%d.%m.%Y)
whitelist=whitelist
whitelistURL="https://raw.githubusercontent.com/AdroitAdorKhan/Energized/master/core/filter/whitelist"
formats=formats
hosts=$formats/hosts
...
raw="https://raw.githubusercontent.com/EnergizedProtection/block/master/$pack/formats"
websiteMirror="https://energized.pro"
...
wget -qO- https://raw.githubusercontent.com/EnergizedProtection/block/master/assets/active/filter/easylist-lite.txt; \
...
wget -qO- https://raw.githubusercontent.com/EnergizedProtection/block/master/assets/active/filter/sbc-hosts.txt; \
